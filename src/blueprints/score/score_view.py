...
def add_score():
    ...
    return render_template('add_score.html', is_logged=current_user.is_authenticated, user=current_user, form=form)
...
def score_list():
    ...
    return render_template('score_list.html', is_logged=current_user.is_authenticated, user=user, ranking=ranking)
